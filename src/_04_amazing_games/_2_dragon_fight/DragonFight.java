...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
				String question = JOptionPane.showInputDialog("Do you want to attack with a yell or a kick?");
			...
			// 		dragon.
				...
				JOptionPane.showMessageDialog(null, "Dragon's Health " + dragonHealth);
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "The dragon has been defeated and you won a ton of gold!");
		System.exit(0);   //This code ends the program
	}
